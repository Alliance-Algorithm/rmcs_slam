...
inline void convert_translation(
    const vector3_wrapper_concept auto& src, vector3_struct_concept auto& dst) {
    dst.x = src.x();
    dst.y = src.y();
    dst.z = src.z();
}
inline void convert_translation(
    const vector3_struct_concept auto& src, vector3_wrapper_concept auto& dst) {
    dst.x() = src.x;
    dst.y() = src.y;
    dst.z() = src.z;
}
inline void convert_translation(
    const vector3_struct_concept auto& src, vector3_struct_concept auto& dst) {
    dst.x = src.x;
    dst.y = src.y;
    dst.z = src.z;
}
inline void convert_translation(
    const vector3_wrapper_concept auto& src, vector3_wrapper_concept auto& dst) {
    dst.x() = src.x();
    dst.y() = src.y();
    dst.z() = src.z();
}
